...
import ExampleCheckbox from "../components/common/CheckBox";
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                >
                  {isLogin ? (
                    <>
                      Press <span style={{ color: "#00ffb3" }}>Start</span> to
                      Dominate!
                    </>
                  ) : (
                    <>
                      Welcome to <span style={{ color: "#00ffb3" }}>COBRA</span>
                    </>
                  )}
                </Typography>
            ...
            >
              ...
              >
                {isLogin ? (
                  <>
                    Login to Your{" "}
                    <span style={{ color: "#00ffb3" }}>Account</span>
                  </>
                ) : (
                  <>
                    Create <span style={{ color: "#00ffb3" }}>Account</span>
                  </>
                )}
              </Typography>
                      ...
                      >
                        ...
                        <DialogContent sx={{ backgroundColor: "#151413 " }}>
                          ...
                          >
                            ...
                            No worries — COBRA’s got your back. Enter your email
                            and we’ll send you the reset link. It’s time to get
                            back in the game
                          </DialogContentText>
                          <TextField
                            sx={{ paddingTop: "10px" }}
